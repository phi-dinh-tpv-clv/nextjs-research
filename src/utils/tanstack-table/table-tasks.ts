...
export default TANSTACK_TABLE_DATA;

export type TableTask = (typeof TANSTACK_TABLE_DATA)[number];

export type TableStatusTask = (typeof STATUSES)[number];
